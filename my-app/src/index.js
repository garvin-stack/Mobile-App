...
const Footer=() => {
    ...
    return (
      <footer> {new Date().toLocaleTimeString()} We
      are the best tour company.
      </footer>
    );
};
...
const Tour = () => {
  return(
    <div>
        <img src="https://wallpaperaccess.com/full/534182.jpg" alt="Arashiyama Bamboo Grove" />
        <h2>Tour</h2>;
        <p>Bamboo Forest, or Arashiyama Bamboo Grove or Sagano Bamboo Forest, is a natural forest of bamboo in Arashiyama, Kyoto, Japan. The forest consists mostly of Moso Bamboo (Phyllostachys edulis) and consists of several pathways for tourists and visitors. The Ministry of the Environment considers it a part of the soundscape of Japan.</p>
    </div>
  );
};
